...
class AppConfig:
    ...
    s_n_r_groups: Dict[str, List[str]] = field(default_factory=dict)
    evaluation: EvaluationConfig = field(default_factory=EvaluationConfig)
    output: OutputConfig = field(default_factory=OutputConfig)
    dotenv_path: str = "src/benchmark/.env"
...
def load_config(config_path: Optional[str] = None) -> AppConfig:
    ...
    config = AppConfig(
        ...
        datasets=datasets,
        s_n_r_groups=raw.get("s_n_r_groups", {}),
        evaluation=evaluation,
        output=output,
        dotenv_path=raw.get("dotenv_path", "src/benchmark/.env"),
    )
